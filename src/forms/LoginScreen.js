    ...
    return(
        <View style={styles.viewMainStyle}>
            <View style={styles.viewTexGroup}>
                    ...
                    <View style={styles.textBoxBackGround}>
                            <TextField label={'Password'} labelColor={'#999999'} highlightColor={'#FF5722'} secureTextEntry={true} />
                    </View>
            </View>
            <View style={styles.viewHButtonStyle}>
                <TwoButtonHComp 
                    PButtonText='LOGIN' 
                    PButtonEvent={() => { console.log('Login Action'); }}
                    SButtonText='REGISTER'
                    SButtonEvent={() =>{ console.log('Regsiter Action'); }} 
                >
                </TwoButtonHComp>
            </View>
        </View>
